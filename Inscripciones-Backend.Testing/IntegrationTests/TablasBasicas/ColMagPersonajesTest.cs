// ColMagPersonajes - APIRest - OData Testing
using System;
...
{
    public class ColMagPersonajesTest
    : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        #region Tests
        [Theory]
        [InlineData("/odata/ColMagPersonajes(ColMagPersonajeId=1234)")]
        ...
        [Theory]
        [InlineData("/odata/ColMagPersonajes(ColMagPersonajeId=-1)")]
        ...
        [Theory]
        [InlineData("/odata/ColMagPersonajes")]
        ...
        [Theory]
        [InlineData("/odata/ColMagPersonajes(ColMagPersonajeId=1236)")]
        ...
        private static ColMagPersonajes rowBase = new ColMagPersonajes() {
            ColMagPersonajeId = 1234,
            ColMagPersonajeNombre = $@"Harry Potter",
            ColMagPersonajeEspecie = $@"human",
            Genero = $@"male",
            ColmagCasaId = 178,
            ColMagPersonajeFechaNacimiento = new DateTime(1980, 7, 31, 12, 0, 0),
        ...
        private static ColMagPersonajes rowAdd = new ColMagPersonajes() {
            ColMagPersonajeId = 1235,
            ColMagPersonajeNombre = $@"Iarry Potter",
            ColMagPersonajeEspecie = $@"iuman",
            Genero = $@"nale",
            ColmagCasaId = 179,
            ColMagPersonajeFechaNacimiento = new DateTime(1980, 7, 31, 12, 0, 0),
            ColMagPersonajeAnoNacimiento = 1981,
            ColMagPersonajeAscendencia = $@"ialf-blood",
            ColMagPersonajeColorOjos = $@"hreen",
            ColMagPersonajeColorCabello = $@"clack",
            ColMagPersonajePatronus = $@"ttag",
            ColMagPersonajeEstudiante = true,
            ColMagPersonajeProfesor = false,
            ColMagPersonajeActor = $@"Eaniel Radcliffe",
            ColMagPersonajeVive = true,
            ColMagPersonajeImagen = $@"ittp://hp-api.herokuapp.com",
            ColMagVaritaMagica = new List<ColMagVaritaMagica>(),
        };

        private static ColMagPersonajes rowDelete = new ColMagPersonajes() {
            ColMagPersonajeId = 1236,
            ColMagPersonajeNombre = $@"Jarry Potter",
            ColMagPersonajeEspecie = $@"juman",
            Genero = $@"oale",
            ColMagPersonajeFechaNacimiento = new DateTime(1980, 7, 31, 12, 0, 0),
            ColMagPersonajeAnoNacimiento = 1982,
            ColMagPersonajeAscendencia = $@"jalf-blood",
            ColMagPersonajeColorOjos = $@"ireen",
            ColMagPersonajeColorCabello = $@"dlack",
            ColMagPersonajePatronus = $@"utag",
            ColMagPersonajeEstudiante = true,
            ColMagPersonajeProfesor = false,
            ColMagPersonajeActor = $@"Faniel Radcliffe",
            ColMagPersonajeVive = true,
            ColMagPersonajeImagen = $@"jttp://hp-api.herokuapp.com",
            ColMagVaritaMagica = new List<ColMagVaritaMagica>(),
        };

        public ColMagPersonajesTest(CustomWebApplicationFactory<Startup> factory)
        {
            ...
            if (factory.Db == null)
            {
                ...
                {
                    if (db.ColMagPersonajes.Count() == 0)
                    {
                        db.ColMagPersonajes.Add(rowBase);
                        db.ColMagPersonajes.Add(rowDelete);
                        db.SaveChanges();
                    }
